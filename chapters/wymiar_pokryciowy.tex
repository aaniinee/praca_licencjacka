...
$\dim \mathbb{R}^n=n$, która została udowodniona w
% todo to nie jest łatwe, dodać cytat
\begin{przy}
...
% to chyba nie ma sensu todo
jako że wymiary pokrywają się na dziedzinie przestrzeni metrycznych ośrodkowych. 
