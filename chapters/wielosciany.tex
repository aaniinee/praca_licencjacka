...
Zauważmy, że korzystając z jednoznaczości współrzędnych barycentrycznych, wszystkie $n$-sympleksy będą wzajemnie homeomorficzne, a dodając do tego ciągłość rzutowania na współrzędne, możemy pokazać ich homeomorficzność z hiperkostką $I^n$, z czego od razu dostajemy, że wymiar pokryciowy każdego $n$-sympleksu będzie dokładnie $n$. 
